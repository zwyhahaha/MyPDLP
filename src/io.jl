"""
A LinearProgrammingProblem struct specifies a linear programming problem
...
"""
Transforms a linear program into a `LinearProgrammingProblem` struct.
The `TwoSidedQpProblem` is destructively modified in place to avoid creating a
copy.

# Returns
A LinearProgrammingProblem struct containing the linear programming
problem.
"""
...
`LinearProgrammingProblem` struct.
...
# Returns
A LinearProgrammingProblem struct.
"""
